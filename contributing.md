# Contributing to ods-diff

First and foremost, thank you! We appreciate that you want to contribute to ods-diff, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for ods-diff**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for ods-diff:

- star the [project](https://github.com/sirap-group/ods-diff)
- tweet your support for ods-diff
...
- **version**: please note the version of ods-diff are you using
...
[so]: http://stackoverflow.com/questions/tagged/ods-diff